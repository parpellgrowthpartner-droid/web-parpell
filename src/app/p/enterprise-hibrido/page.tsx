...
export const metadata: Metadata = {
  title: "Packs & Tarifas Híbridas Enterprise: Infraestructura Audiovisual & CTO as a Service",
...
const packsGrande: PricingPack[] = [
  ...
  },
  {
    ...
    period: "/mes",
    description: "El ecosistema corporativo definitivo: 16 vídeos de cine, Paid Media global, embudo ManyChat, integraciones a medida y optimización IA continua.",
    includesSummary: ["16 Reels Cine", "Paid Media Global", "Integraciones ERP/APIs", "Motor IA Multimodelo"],
    features: [
      ...
      "Desarrollo e integración de APIs, ERP, CRM y flujos automatizados a medida",
    ...
    deliverables: "16 Reels cine + Paid Media Global + ManyChat Integral + Integraciones ERP + Motor IA",
  },
  {
    ...
    features: [
      ...
      "Dedicación de ingeniería de software continua y workflows de IA interna para tu empresa",
      "Auditorías avanzadas de ciberseguridad, penetración y cumplimiento normativo",
      "Exclusividad sectorial y geográfica total: no trabajamos con tus competidores directos",
      "Canal VIP prioritario 24/7 y asesoramiento ejecutivo directo con los 2 socios",
    ],
...
const servicesGrande: ServiceItem[] = [
  ...
  },
  {
    ...
    detail: "Conectores a medida para sincronizar flujos de clientes, pedidos y bases de datos.",
    price: "850€",
  },
  {
    name: "Consultoría Estratégica & Formación Comercial",
    detail: "Sesiones de entrenamiento comercial de ventas y workflows de IA interna para tu equipo.",
    price: "800€",
  },
];
