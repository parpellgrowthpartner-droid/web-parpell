...
const packsGrande: PricingPack[] = [
  {
    ...
    features: [
      ...
      "Auditoría mensual de huella digital técnica y rendimiento de infraestructura web",
    ],
  ...
  },
  {
    ...
    features: [
      ...
      "Informe mensual de posicionamiento multimodelo en IA (ChatGPT, Claude, Gemini, SearchGPT)",
      "Informe mensual de palabras clave transaccionales y análisis competitivo",
    ],
  ...
  },
  {
    ...
    features: [
      ...
      "Auditoría mensual 360° de presencia en IA (GEO) y salud técnica de infraestructura",
      "Informe mensual de telemetría de captación, CTR y brechas frente a rivales",
